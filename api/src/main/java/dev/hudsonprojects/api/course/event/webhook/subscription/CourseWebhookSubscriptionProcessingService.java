...
@Service
public class CourseWebhookSubscriptionProcessingService {
    ...
    @Autowired
    public CourseWebhookSubscriptionProcessingService(WebhookRepository webhookRepository, WebhookService webhookService, RequestData requestData) {
