...
public class SubscriptionService {
    ...
    @Autowired
    public SubscriptionService(SubscriptionAdapter subscriptionAdapter, SubscriptionRepository subscriptionRepository, CourseService courseService, SubscriptionValidationService subscriptionValidationService) {
